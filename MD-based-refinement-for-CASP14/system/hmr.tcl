...
# this script is provided by Karl Lundquist <kplundqu@purdue.edu>
...
if { [llength $argv] != 2 } {
  ...
  to run simulations using a 4-fs time step. Currently, we are testing this with
  Amber, although others have found that it works with NAMD too.  To run, type \n 
